...
const EditReviewModal = ({ isOpen, onClose, onSave, review }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setErrors({ submit: 'Failed to update review. Please try again.' });
        } finally {
            ...
            >
                ...
                >
                    ...
                    <p style={{
                        ...
                        Update your experience at <strong style={{ color: 'var(--primary-color)' }}>{review.hotelName}</strong>
                    </p>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                placeholder="Update your experience with this hotel..."
                                rows="5"
                                style={{
